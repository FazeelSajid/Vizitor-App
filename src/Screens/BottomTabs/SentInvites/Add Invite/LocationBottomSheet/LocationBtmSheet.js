...
const Location = ({ location, bottomSheetRef, setSelected, selectedLocation }) => {
    ...
    >
      ...
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <TxtInput placeholder={'Search'} selectableColor={COLORS.black} placeholderTextColor={COLORS.darkGraytext} containerStyle={[styles.txtInput, Platform.OS === 'ios' && { height: hp(5.4) }]} svg={<Search />} onChangeText={setSearchQuery} />
        </View>
        ...
        <BottomSheetFlatList
          ...
          renderItem={({ item }) => (
            ...
            >
              ...
              {selectedLocation && selectedLocation.BranchId === item.BranchId && <CheckBoxBlueTick width={wp(6)} />}
            </TouchableOpacity>
          )}
          scrollEnabled={true}
        />
