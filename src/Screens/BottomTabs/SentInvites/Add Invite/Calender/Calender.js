...
const Calender = ({bottomSheetRef, heading, setDate,setDatee}) => {
      ...
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <View style={styles.dateRow}>
            <Text style={styles.title}>{moment(selectedDate).format('D MMM yy')}</Text>
        ...
        <Calendar
          ...
          onDayPress={(day) => {
            ...
            const result = formatDate(day.dateString)
            // setDate(result)
            setDatee(day.dateString)
